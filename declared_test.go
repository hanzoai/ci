...
func TestDeclaredReadsTheFleetsShapes(t *testing.T) {
	cases := []struct {
		...
		want:  Artifact{Tag: "v1.801.548", Digest: "sha256:8830c2b1"},
	}, {
...
func TestSplitImageKeepsBothNames(t *testing.T) {
	cases := []struct {
		...
		{"ghcr.io/hanzoai/cloud:v1.801.548@sha256:8830c2b1", "ghcr.io/hanzoai/cloud",
			Artifact{Tag: "v1.801.548", Digest: "sha256:8830c2b1"}},
		{"ghcr.io/hanzoai/cloud:v1.801.548", "ghcr.io/hanzoai/cloud", Artifact{Tag: "v1.801.548"}},
		{"ghcr.io/hanzoai/cloud@sha256:8830", "ghcr.io/hanzoai/cloud", Artifact{Digest: "sha256:8830"}},
		{"ghcr.io/hanzoai/cloud", "ghcr.io/hanzoai/cloud", Artifact{}},
		// A colon before the last slash is a registry port, not a tag.
		{"oci.hanzo.ai:5000/hanzo/a:v1", "oci.hanzo.ai:5000/hanzo/a", Artifact{Tag: "v1"}},
		{"oci.hanzo.ai:5000/hanzo/a", "oci.hanzo.ai:5000/hanzo/a", Artifact{}},
	}
	for _, tc := range cases {
